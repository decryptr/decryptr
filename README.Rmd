...
known sources. If you wanted to use this package with, let's say, RFB (Receita
Federal), you could go by the following steps:
...
files <- download_captcha("rfb", n = 10, path = "./img")
new_files <- classify(files, path = "./img", model = load_model("rfb"))
```
